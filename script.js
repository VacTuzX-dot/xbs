      ...
      <div class="container">
        ...
        >
         ...
         <div class="col">
          <h3>Contact</h3>
           <ul class="nav gap-4">
              <li class="nav-item mb-2 fb">
              <a href="https://web.facebook.com/ImaginaryfriendNDplasticfriend/" class="nav-link p-0 " target="_blank"><i class=" fa-brands fa-facebook"> Facebook</i></a>
             </li>
              <li class="nav-item mb-2 ig">
              <a href="https://www.instagram.com/v4lk.yrieq_1sf3sb.o8lixw/" class="nav-link p-0 text-danger" target="_blank"><i class="fa-brands fa-instagram"> Instagram</i></a>
             </li>
            </ul>
          </div>
        </footer>
